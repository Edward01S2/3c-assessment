<div class="{{ $block->classes }} mb-12">
  <div class="container px-6 mx-auto lg:px-8 md:max-w-6xl">
    <div>
      ...
      <div class="mb-8 sm:max-w-sm sm:mx-auto lg:max-w-md">
        <select name="category" id="resource-cat" class="w-full lg:text-lg lg:py-3">
          {{-- @foreach($cats as $cat)
            ...
            @endif
          @endforeach --}}
          <option value="gwgr" <?php if('gwgr' == $content) echo ' selected="selected"'; ?>>Grow with Google</option>
      ...
      <div
        class="grid grid-rows-{!! $count !!} gap-6 auto-rows-fr sm:grid-rows-none sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
        {{-- @dump($posts) --}}
